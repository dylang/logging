...
var clusterCPU = isWorker ? Style(Style.GREEN, Cluster.worker.id + '.')
    : 'CLUSTER_UNIQUE_ID' in process.env ? Style(Style.GREEN, CLUSTER_UNIQUE_ID + '.')
    : 'NODE_WORKER_ID' in process.env ? Style(Style.GREEN, process.env.NODE_WORKER_ID + '.')
