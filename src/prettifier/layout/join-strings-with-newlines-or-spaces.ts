...
export const joinStringsWithNewlinesOrSpaces = (contentArray: string[]) =>
    contentArray.reduce((acc, current, index) => {
        ...
        const addNewlineBeforeCurrent =
            index > 0 && !startsWithNewline && (tooLongForLine || previousOrCurrentIncludesNewline);
